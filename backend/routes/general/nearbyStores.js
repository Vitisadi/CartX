...
router.put(`/${parsed.name}`, async (req, res) => {
  ...
  let address = "1761 15th St, Troy, NY 12180";
  ...
  const apiUrl = `https://maps.googleapis.com/maps/api/place/nearbysearch/json?keyword=shoprite&location=${location}&key=${googleKey}&radius=16093.4`;
